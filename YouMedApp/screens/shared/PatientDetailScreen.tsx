      ...
      <View className="px-4 py-3">
        {patient && (
          <View className="mt-3 rounded-lg bg-white p-4 shadow-sm">
            <SectionHeader title="Patient Information" icon="body" color={getIconColor(user?.role)}/>
            ...
            <Pressable
              className={`mt-2 self-end rounded-lg bg-${getBackgroundColor(user?.role)}-500 px-3 py-1`}
        ...
        {insurance ? (
          <View className="mt-3 rounded-lg bg-white p-4 shadow-sm">
            <SectionHeader title="Patient Health Insuarance" icon="medical" color={getIconColor(user?.role)}/>
          ...
          <View className="mt-3 rounded-lg bg-white p-4 shadow-sm">
            <Text className="text-center text-base text-teal-800">
