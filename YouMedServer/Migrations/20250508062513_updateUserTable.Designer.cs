...
namespace YouMedServer.Migrations
{
    ...
    [Migration("20250508062513_updateUserTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YouMedServer.Models.Entities.AppointmentClinicalService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ClinicalServiceID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClinicalServiceID");

                    b.HasIndex("RecordID");

                    b.ToTable("AppointmentClinicalServices");
                });
            ...
            modelBuilder.Entity("YouMedServer.Models.Entities.ClinicalService", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ClinicalServiceID"));
                    ...
                    b.HasKey("ClinicalServiceID");

                    b.HasIndex("ClinicID");

                    b.ToTable("ClinicalServices");
                });
            ...
            modelBuilder.Entity("YouMedServer.Models.Entities.DoctorSchedule", b =>
                {
            ...
            modelBuilder.Entity("YouMedServer.Models.Entities.MedicalRecord", b =>
                {
                    ...
                    b.Property<bool>("IsScheduleFollowUp")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("YouMedServer.Models.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("YouMedServer.Models.Entities.Doctor", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YouMedServer.Models.Entities.Patient", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("YouMedServer.Models.Entities.AppointmentClinicalService", b =>
                {
                    b.HasOne("YouMedServer.Models.Entities.Appointment", "Appointment")
                        .WithMany()
                        .HasForeignKey("AppointmentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YouMedServer.Models.Entities.ClinicalService", "ClinicalService")
                        .WithMany()
                        .HasForeignKey("ClinicalServiceID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YouMedServer.Models.Entities.MedicalRecord", "MedicalRecord")
                        .WithMany()
            ...
            modelBuilder.Entity("YouMedServer.Models.Entities.ClinicSpecialty", b =>
                {
                    ...
                    b.HasOne("YouMedServer.Models.Entities.Specialty", "Specialty")
                        .WithMany()
